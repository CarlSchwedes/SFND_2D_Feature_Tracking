...
void detKeypointsHarris(std::vector<cv::KeyPoint> &keypoints, cv::Mat &img, float &timing, bool bVis)
{
    // Detector parameters
...
void detKeypointsShiTomasi(vector<cv::KeyPoint> &keypoints, cv::Mat &img, float &timing, bool bVis)
{
